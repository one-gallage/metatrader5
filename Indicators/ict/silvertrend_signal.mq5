...
//----     
  ...
  {
//----
   Print("Silver Trend ",EnumToString(Period())," ",Symbol()," ", txt);
   //Alert("Silver Trend ",EnumToString(Period())," ",Symbol()," ", txt);
   //if(SoundAlert==true&&pos==1){PlaySound("alert.wav");}
   //if(EmailAlert==true&&pos==1){SendMail("Silver Trend: "+txt,txt);}
//----
  }
//+------------------------------------------------------------------+